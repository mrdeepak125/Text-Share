...
useEffect(() => {
  // Use environment variables or a config file for server URLs in production
  ...
  myPeerRef.current = new Peer({
    host: serverUrl.replace(/^https?:\/\//, ''), // Remove protocol
    port: 443, // Use 443 for HTTPS
    path: '/peerjs', // Make sure this matches your server configuration
    secure: true, // Required for HTTPS
    debug: 3, // For debugging connection issues
  });
